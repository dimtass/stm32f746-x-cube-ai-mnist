...
#ifndef __AI_MNISTKERAS_H__
#define __AI_MNISTKERAS_H__
#pragma once

#include "ai_platform.h"

#define AI_MNISTKERAS_MODEL_NAME          "mnistkeras"

#define AI_MNISTKERAS_IN_NUM       (1)
#define AI_MNISTKERAS_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 28, 1, 1, NULL), \
}
#define AI_MNISTKERAS_IN_SIZE { \
  (28 * 28 * 1), \
}
#define AI_MNISTKERAS_IN_1_SIZE  (28 * 28 * 1)
#define AI_MNISTKERAS_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)


#define AI_MNISTKERAS_OUT_NUM      (1)
#define AI_MNISTKERAS_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_MNISTKERAS_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_MNISTKERAS_OUT_1_SIZE  (1 * 1 * 10)
#define AI_MNISTKERAS_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)
 ...
 * @ref ai_mnistkeras_create. Both the activations memory buffer 
 ...
 * using @ref ai_mnistkeras_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_MNISTKERAS_*
 * defines into file @ref mnistkeras.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_mnistkeras_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_MNISTKERAS_H__*/
